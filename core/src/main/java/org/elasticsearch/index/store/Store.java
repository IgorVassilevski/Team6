...
public class Store extends AbstractIndexShardComponent implements Closeable, RefCounted {
     ...
     * @throws IOException if the index is corrupted or the segments file is not present
     */
    protected static SegmentInfos readSegmentsInfo(IndexCommit commit, Directory directory) throws IOException {
    ...
    public void cleanupAndVerify(String reason, MetadataSnapshot sourceMetaData) throws IOException {
        ...
        try (Lock writeLock = directory.obtainLock(IndexWriter.WRITE_LOCK_NAME)) {
            ...
            final MetadataSnapshot metadataOrEmpty = getMetadata();
    ...
    */
     ...
     *
     * @see MetadataSnapshot#recoveryDiff(org.elasticsearch.index.store.MetadataSnapshot)
     */
